...
const blogPosts = [
  {
    ...
    // Código de inserción de Instagram (Reel 1)
    ...
    content: (
      <div className="space-y-6 text-textGray leading-relaxed">
        ...
        <h4 className="font-bold text-dark text-xl mt-8">El valor de ser verdaderamente escuchado</h4>
        <p>Lo primero que destaca en el video es el ambiente de calma y bienvenida. A diferencia de las consultas tradicionales donde el reloj siempre parece apremiar, la filosofía de este espacio es muy diferente y liberadora: <em>"Aquí vienes a soltar, no a explicar con prisa"</em>.</p>
        ...
        <h4 className="font-bold text-dark text-xl mt-8">Conectando los síntomas</h4>
        ...
        <p>Frente a esto, el mensaje de la terapeuta es claro y reconfortante: <em>"Todo lo que sientes... importa"</em>. En la medicina holística, ningún síntoma es aislado; todos son piezas clave para entender el estado general del cuerpo y la mente.</p>
        
        <h4 className="font-bold text-dark text-xl mt-8">El inicio del diagnóstico</h4>
        ...
        <h4 className="font-bold text-dark text-xl mt-8">¿Te animas a dar el paso?</h4>
  ...
  },
  {
    ...
    // Código de inserción de Instagram (Reel 2)
    ...
    content: (
      <div className="space-y-6 text-textGray leading-relaxed">
        ...
        <h4 className="font-bold text-dark text-xl mt-8">El lenguaje silencioso de tu cuerpo</h4>
        <p>El video nos muestra cómo la terapeuta va más allá de las palabras de Paula. A través de técnicas tradicionales y milenarias, como la <strong>lectura de la lengua y el pulso</strong>, Yeni comienza a descifrar el estado interno de la paciente. Como bien nos recuerda el video: <em>"La lengua, el pulso, los puntos de tensión... todo habla"</em>. Para la medicina holística, estas herramientas son el mapa perfecto para entender cómo fluye nuestra energía.</p>
        
        <h4 className="font-bold text-dark text-xl mt-8">Descifrando los mensajes, no los enemigos</h4>
        <p>Uno de los mensajes más poderosos de esta sesión es cambiar nuestra perspectiva sobre el dolor: <em>"Cada síntoma es un mensaje, no un enemigo"</em>. Durante la evaluación, Yeni y Paula van conectando las piezas del rompecabezas:</p>
        <ul className="list-disc pl-6 space-y-2">
  ...
  },
  {
    ...
    // Código de inserción de Instagram (Reel 3)
    ...
    content: (
      <div className="space-y-6 text-textGray leading-relaxed">
        ...
        <h4 className="font-bold text-dark text-xl mt-8">El mapa del dolor a través de la palpación</h4>
        ...
        <h4 className="font-bold text-dark text-xl mt-8">Resultados sorprendentes en segundos</h4>
        <p>Aquí es donde presenciamos lo fascinante de la acupuntura y las terapias holísticas. En lugar de tratar directamente la zona adolorida del estómago, Yeni coloca una sola aguja en la pantorrilla de Paula. Al volver a palpar el abdomen casi de inmediato, la respuesta del cuerpo es increíble: el dolor baja significativamente y la paciente confirma sentirse <em>"mucho mejor"</em>. Esto nos demuestra cómo los canales de nuestro cuerpo están interconectados de maneras asombrosas.</p>
        
        <h4 className="font-bold text-dark text-xl mt-8">Los puntos "limpiadores" para un alivio total</h4>
        <p>Para eliminar el último pequeño rastro de molestia que quedaba en el vientre, la terapeuta recurre a un ajuste final: estimula un punto específico en el pie. Una vez más, el alivio es instantáneo y la tensión desaparece por completo. Tras esto, coloca una aguja en ese punto del pie, actuando como un "limpiador" para consolidar el equilibrio en el organismo.</p>
        
        <h4 className="font-bold text-dark text-xl mt-8">Una metodología rápida y efectiva</h4>
        ...
        <h4 className="font-bold text-dark text-xl mt-8">Descubre el alivio por ti mismo</h4>
...
const Blogs: React.FC = () => {
  ...
  useEffect(() => {
    if (selectedPost) {
      // Evitamos que el scroll del body se mueva cuando el modal está abierto
    ...
    <div>
      ...
      <section className="bg-light py-20">
        <div className="max-w-[1140px] mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-dark mb-4">Experiencias y Tratamientos</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post) => (
              <div 
                key={post.id} 
                className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer flex flex-col h-full"
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-dark text-white text-xs font-bold px-3 py-1 rounded-full">
                    {post.category}
                  </div>
                </div>
                <div className="p-6 flex flex-col flex-grow">
                  <div className="text-sm text-secondary font-medium mb-3">{post.date}</div>
                  <h3 className="text-xl font-bold text-dark mb-4 line-clamp-3 hover:text-primary transition-colors">
                    {post.title}
                  </h3>
                  <div className="mt-auto pt-4 border-t border-gray-100 flex items-center gap-2 text-textGray text-sm">
                    <User size={16} />
      ...
      {selectedPost && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <div className="bg-white rounded-2xl w-full max-w-6xl max-h-[90vh] overflow-y-auto flex flex-col lg:flex-row relative z-10 animate-slide-in-left shadow-2xl">
            {/* Botón Cerrar */}
            <button 
              onClick={() => setSelectedPost(null)} 
              className="absolute top-4 right-4 z-50 bg-white hover:bg-gray-100 text-dark rounded-full p-2 shadow-lg transition-colors"
              aria-label="Cerrar"
            >
              <X size={24} />
            </button>
            ...
            <div className="w-full lg:w-5/12 bg-gray-50 flex items-start justify-center p-6 lg:p-10 border-b lg:border-b-0 lg:border-r border-gray-200">
              <div 
            ...
            <div className="w-full lg:w-7/12 p-8 lg:p-12">
              <div className="inline-block bg-light text-primary text-xs font-bold px-3 py-1 rounded-full mb-4">
                {selectedPost.category} • {selectedPost.date}
              </div>
              <h2 className="text-3xl lg:text-4xl font-bold text-dark mb-8 leading-tight">
                {selectedPost.title}
              </h2>
