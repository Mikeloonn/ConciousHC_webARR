...
const blogPosts = [
  {
    ...
    content: (
      <div className="space-y-6 text-[#d1d7c7]/80 text-sm md:text-base leading-relaxed pb-12">
        ...
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">El valor de ser verdaderamente escuchado</h4>
        <p>Lo primero que destaca en el video es el ambiente de calma y bienvenida. A diferencia de las consultas tradicionales donde el reloj siempre parece apremiar, la filosofía de este espacio es muy diferente y liberadora: <em className="text-[#df9e53]">"Aquí vienes a soltar, no a explicar con prisa"</em>.</p>
        ...
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">Conectando los síntomas</h4>
        <p>Durante la consulta, vemos cómo la paciente comparte sus malestares cotidianos:</p>
        <ul className="list-disc pl-6 space-y-2 marker:text-[#df9e53]">
          <li>Sensación constante de inflamación.</li>
          <li>Digestiones muy pesadas.</li>
          <li>Dolor persistente en la boca del estómago.</li>
        </ul>
        <p>Frente a esto, el mensaje de la terapeuta es claro y reconfortante: <em className="text-[#df9e53]">"Todo lo que sientes... importa"</em>. En la medicina holística, ningún síntoma es aislado; todos son piezas clave para entender el estado general del cuerpo y la mente.</p>
        
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">El inicio del diagnóstico</h4>
        ...
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">¿Te animas a dar el paso?</h4>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-[#d1d7c7]/80 text-sm md:text-base leading-relaxed pb-12">
        ...
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">El lenguaje silencioso de tu cuerpo</h4>
        <p>El video nos muestra cómo la terapeuta va más allá de las palabras de Paula. A través de técnicas tradicionales y milenarias, como la <strong>lectura de la lengua y el pulso</strong>, Yeni comienza a descifrar el estado interno de la paciente. Como bien nos recuerda el video: <em className="text-[#df9e53]">"La lengua, el pulso, los puntos de tensión... todo habla"</em>. Para la medicina holística, estas herramientas son el mapa perfecto para entender cómo fluye nuestra energía.</p>
        
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">Descifrando los mensajes, no los enemigos</h4>
        <p>Uno de los mensajes más poderosos de esta sesión es cambiar nuestra perspectiva sobre el dolor: <em className="text-[#df9e53]">"Cada síntoma es un mensaje, no un enemigo"</em>. Durante la evaluación, Yeni y Paula van conectando las piezas del rompecabezas:</p>
        <ul className="list-disc pl-6 space-y-2 marker:text-[#df9e53]">
        ...
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">Del diagnóstico a la acción</h4>
        <p>El momento clave llega cuando todas las señales encajan. Con una frase llena de empatía y seguridad, Yeni le dice a la paciente: <em className="text-[#df9e53]">"Y ahora que sé lo que necesitas... empiezo a ayudarte"</em>. Es el instante de dejar las palabras atrás, quitarse los zapatos y pasar a la camilla para comenzar el verdadero trabajo de sanación.</p>
        
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">¿Listo para descubrir qué dice tu cuerpo?</h4>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-[#d1d7c7]/80 text-sm md:text-base leading-relaxed pb-12">
        ...
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">El mapa del dolor a través de la palpación</h4>
        ...
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">Resultados sorprendentes en segundos</h4>
        <p>Aquí es donde presenciamos lo fascinante de la acupuntura y las terapias holísticas. En lugar de tratar directamente la zona adolorida del estómago, Yeni coloca una sola aguja en la pantorrilla de Paula. Al volver a palpar el abdomen casi de inmediato, la respuesta del cuerpo es increíble: el dolor baja significativamente y la paciente confirma sentirse <em className="text-[#df9e53]">"mucho mejor"</em>. Esto nos demuestra cómo los canales de nuestro cuerpo están interconectados de maneras asombrosas.</p>
        
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">Los puntos "limpiadores" para un alivio total</h4>
        ...
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">Una metodología rápida y efectiva</h4>
        ...
        <h4 className="font-serif text-2xl lg:text-3xl text-[#e8ebe3] mt-10 mb-4">Descubre el alivio por ti mismo</h4>
...
const Blogs: React.FC = () => {
  ...
  return (
    <main className="bg-[#0a0a08] text-[#e8ebe3] min-h-screen w-full overflow-hidden pb-20">
      ...
      />
      <PageHeader title="NUESTRAS HISTORIAS" breadcrumb="Historias" />
      
      <section className="relative py-24 md:py-32">
        <div className="orb w-[400px] h-[400px] bg-[#bc9674] top-1/3 -left-32 parallax-layer z-0 opacity-10" data-speed="0.025"></div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-16">
            <div className="reveal-up">
              ...
              <h2 className="section-heading text-[clamp(2rem,5vw,4rem)] mt-4">
                Nuestro <span className="italic text-[#b3bda3]">Blog</span>
              </h2>
            ...
            {blogPosts.map((post) => (
              ...
              >
                ...
                <div className="relative w-full h-[450px] lg:h-[550px] shrink-0 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 bg-[#0a0a08]/80 backdrop-blur-md text-[#df9e53] text-[0.65rem] tracking-[0.2em] uppercase px-3 py-1.5 rounded-full border border-[#df9e53]/30 z-10">
                    {post.category}
                  </div>
                </div>
                ...
                <div className="pt-6 flex flex-col flex-grow">
                  <span className="text-[0.65rem] tracking-[0.2em] uppercase text-[#df9e53]/80">{post.date}</span>
                  <h3 className="font-serif text-lg lg:text-xl mt-3 mb-4 leading-snug text-[#e8ebe3] group-hover:text-[#b3bda3] transition-colors line-clamp-3">
                    {post.title}
                  </h3>
                  <div className="mt-auto flex items-center gap-3 pt-6 border-t border-[#e8ebe3]/10 text-[0.65rem] text-[#b3bda3]/50 uppercase tracking-widest">
                    <User size={14} />
      ...
      {selectedPost && (
        <div className="fixed inset-0 z-[9980] flex items-center justify-center p-4 sm:p-6 pt-[80px] md:pt-[100px]">
          ...
          <div 
            className="absolute inset-0 bg-[#0a0a08]/90 backdrop-blur-md z-0"
            onClick={() => setSelectedPost(null)}
          ></div>
          
          {/* Contenedor Modal: Abarca el centro del espacio libre debajo del Navbar */}
          <div className="relative w-full max-w-6xl max-h-[85vh] glass-card z-10 bg-[#1a1a18]/90 overflow-y-auto" data-lenis-prevent="true">
            ...
            <div className="sticky top-0 z-50 flex justify-end w-full" style={{ height: 0 }}>
              <button 
                onClick={() => setSelectedPost(null)} 
                className="absolute top-4 right-4 bg-[#0a0a08]/80 hover:bg-[#df9e53] text-[#e8ebe3] rounded-full p-2 shadow-lg transition-colors border border-[#e8ebe3]/20 backdrop-blur-sm"
                aria-label="Cerrar"
              >
                <X size={20} />
              </button>
            ...
            <div className="flex flex-col lg:flex-row w-full min-h-full">
              ...
              <div className="w-full lg:w-5/12 bg-[#0a0a08]/30 flex items-start justify-center p-6 lg:p-10 border-b lg:border-b-0 lg:border-r border-[#e8ebe3]/5 pt-12">
                <div 
              ...
              <div className="w-full lg:w-7/12 p-8 lg:p-12 flex flex-col justify-start pt-12">
                <div className="inline-block self-start bg-gradient-to-r from-[#b3bda3]/20 to-transparent text-[#b3bda3] text-[0.65rem] tracking-[0.2em] uppercase px-4 py-2 rounded-full mb-6 border border-[#b3bda3]/30">
                  {selectedPost.category} • {selectedPost.date}
                </div>
                <h2 className="font-serif text-3xl lg:text-4xl font-light text-[#e8ebe3] mb-8 leading-tight pr-8">
                  {selectedPost.title}
                </h2>
