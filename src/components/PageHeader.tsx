...
const PageHeader: React.FC<PageHeaderProps> = ({ title, breadcrumb, children }) => {
  ...
  return (
    <div className="relative h-[40vh] min-h-[350px] max-h-[500px] flex items-center text-[#e8ebe3] overflow-hidden">
      ...
      {/* Overlay oscuro: mismo gradiente suave para móviles y escritorio */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a08]/80 via-[#0a0a08]/40 to-transparent z-0 pointer-events-none transition-colors duration-500"></div>
